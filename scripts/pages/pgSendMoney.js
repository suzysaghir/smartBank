...
function onLoad(superOnLoad) {
	...
	listView1.onRowBind = function(listViewItem, index) {
		...
		listViewItem.borderColor = Color.create("#f2f2f2");
		// listViewItem.onTouch = () => listViewItem.backgroundColor = Color.create("#f2f2f2");
		listViewItem.onTouchEnd = () => listViewItem.backgroundColor = Color.WHITE;
