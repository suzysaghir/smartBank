...
// Constructor
function $PgRegisterPersonalDetails2(_super, props) {
	...
	pageContextPatch(this, 'pgRegisterPersonalDetails2');
}
$PgRegisterPersonalDetails2.$$styleContext = {
...
const $PgRegisterPersonalDetails2_ = Page($PgRegisterPersonalDetails2);
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb(_super, pageInstance) {
	...
	addChild.call(
		this,
		'mtbBirthDate',
		$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbBirthDate_,
		pageInstance
	);
}
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbBirthDate(
	_super,
	pageInstance
) {
	_super(this);
...
$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbBirthDate.$$styleContext = {
	classNames: '.materialTextBox-wrapper',
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: { flexProps: { positionType: 'RELATIVE' }, left: 0, top: 0 }
};
const $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbBirthDate_ = Materialtextbox(
	$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbBirthDate
);
...
module.exports = $PgRegisterPersonalDetails2_;
