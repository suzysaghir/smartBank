...
// Constructor
function $PgRegisterAddress_1(_super, props) {
	...
	pageContextPatch(this, 'pgRegisterAddress_1');
}
$PgRegisterAddress_1.$$styleContext = {
...
const $PgRegisterAddress_1_ = Page($PgRegisterAddress_1);
...
function $FlexLayout1$$FlexLayout1(_super, pageInstance) {
	...
	addChild.call(
		this,
		'tvAddressDetails',
		$FlexLayout1$$FlexLayout1$$TvAddressDetails_,
		pageInstance
	);
	addChild.call(
		this,
...
function $FlexLayout1$$FlexLayout1$$TvAddressDetails(_super, pageInstance) {
	_super(this);
...
$FlexLayout1$$FlexLayout1$$TvAddressDetails.$$styleContext = {
	classNames: '.sf-textView',
	defaultClassNames: '.default_common .default_textView',
	userProps: {}
};
const $FlexLayout1$$FlexLayout1$$TvAddressDetails_ = TextView(
	$FlexLayout1$$FlexLayout1$$TvAddressDetails
);
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb(_super, pageInstance) {
	...
	addChild.call(
		this,
		'mtbPostalCode',
		$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbPostalCode_,
		pageInstance
	);
	addChild.call(
		this,
		'mtbAddress',
		$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbAddress_,
		pageInstance
	);
}
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$FlexLayout1(
	...
	addChild.call(
		this,
		'mtbCountry',
		$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$FlexLayout1$$MtbCountry_,
		pageInstance
	);
	addChild.call(
		this,
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$FlexLayout1$$MtbCountry(
	_super,
	pageInstance
) {
	_super(this);
...
$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$FlexLayout1$$MtbCountry.$$styleContext = {
...
$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$FlexLayout1$$View1.$$styleContext = {
	...
	userProps: {
		...
		flexProps: { alignSelf: 'CENTER', positionType: 'ABSOLUTE' },
		height: 48,
		width: 1000
	}
};
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbPostalCode(
	_super,
	pageInstance
) {
	_super(this);
...
$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbPostalCode.$$styleContext = {
	classNames: '.materialTextBox-wrapper',
	defaultClassNames: '.default_common .default_flexLayout',
...
function $FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbAddress(
	_super,
	pageInstance
) {
	_super(this);
...
$FlexLayout1$$FlexLayout1$$FlexLayout_mtb$$MtbAddress.$$styleContext = {
	classNames: '.materialTextBox-wrapper',
	defaultClassNames: '.default_common .default_flexLayout',
	userProps: {
		flexProps: { positionType: 'RELATIVE' },
...
module.exports = $PgRegisterAddress_1_;
