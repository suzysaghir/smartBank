...
function $PgCards(_super, props) {
	...
	pageContextPatch(this, 'pgCards');
}
$PgCards.$$styleContext = {
	classNames: '.sf-page',
...
const $PgCards_ = Page($PgCards);
function $Label1(_super, pageInstance) {
	_super(this, { text: 'Cards page' });
}
$Label1.$$styleContext = {
	classNames: '.sf-label',
